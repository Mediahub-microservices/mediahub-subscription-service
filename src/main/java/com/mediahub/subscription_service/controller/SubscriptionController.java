...
public class SubscriptionController {
    ...
    public ApiResponse<List<SubscriptionResponse>> getUserSubscriptions(@PathVariable UUID userId){
        return ApiResponse.success(
    ...
    public ApiResponse<Boolean> hasActive(@PathVariable UUID userId){
        return ApiResponse.success(
